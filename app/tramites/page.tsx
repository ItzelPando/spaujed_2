...
import UploadPDFButton from "@/components/UploadPDFButton/UploadPDFButton";// Componente importado
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Información sobre trámites y servicios ofrecidos por SPAUJED." />
      </Head>
